...
<body>
    <center>
        <form action="<?= base_url('sepatu/cetak'); ?>" method="post">
            ...
            <table bgcolor='#ff80ff' width="1080px">
                <tr>
                    <th>
                        <h3>TOKO SEPATU Aldi</h3>
                        <hr>
                    </th>
                </tr>
                ...
                <tr>
                    <td align="center"> <input type="text" name='no' id='no' placeholder="No HP"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center"><b>UKURAN SEPATU :</b></td>
                </tr>
                <tr>
                    <td align="center">
